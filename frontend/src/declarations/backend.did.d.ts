...
export interface _SERVICE {
  ...
  'getMemberBalance' : ActorMethod<
    [Principal],
    { 'totalPaid' : bigint, 'paymentCount' : bigint }
  >,
  'getPayments' : ActorMethod<[Principal], Array<Payment>>,
  'getSummaryStats' : ActorMethod<
    [],
    { 'totalAmountCollected' : bigint, 'totalMembers' : bigint }
  >,
  'getUserProfile' : ActorMethod<[Principal], [] | [UserProfile]>,
  'isCallerAdmin' : ActorMethod<[], boolean>,
  'recordPayment' : ActorMethod<[Principal, bigint], undefined>,
