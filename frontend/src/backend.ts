...
import type { ExternalBlob as _ExternalBlob, Member as _Member, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getMemberBalance(arg0: Principal): Promise<{
        totalPaid: bigint;
        paymentCount: bigint;
    }> {
        if (this.processError) {
            try {
                const result = await this.actor.getMemberBalance(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPayments(arg0: Principal): Promise<Array<Payment>> {
        if (this.processError) {
            try {
    ...
    async recordPayment(arg0: Principal, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
...
async function from_candid_Member_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Member): Promise<Member> {
...
async function from_candid_opt_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Member]): Promise<Member | null> {
    return value.length === 0 ? null : await from_candid_Member_n11(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Member>): Promise<Array<Member>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Member_n11(_uploadFile, _downloadFile, x)));
}
...
async function to_candid_record_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        name: value.name,
        profilePhoto: value.profilePhoto ? candid_some(await to_candid_ExternalBlob_n23(_uploadFile, _downloadFile, value.profilePhoto)) : candid_none(),
        joiningDate: value.joiningDate,
        mobile: value.mobile
    };
}
